...
const addMetadata = _edition => {
  ...
  const randobando = Math.round(Math.random() * 100);
      ...
      if (randobando <= 22){rarityForEdition = "Rare"; var hashrate = 4;}
      if (randobando <= 6.5){rarityForEdition = "Epic"; var hashrate = 8;}
      if (randobando <= 1.5){rarityForEdition = "Legendary"; var hashrate = 24;}
  ...
  hash = [];
  decodedHash = [];
  console.log("25% boost mint initiated with " + rarityForEdition + " rarity (#" + _edition + ")");
};
